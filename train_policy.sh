...
python ase/run.py --task HumanoidAMPCarry --cfg_env ase/data/cfg/env/humanoid_amp_carry.yaml --cfg_train ase/data/cfg/train/rlg/amp_task.yaml --motion_file ase/data/cfg/data/walk.yaml 